...
-- 3) Gerador de cores
geraCores :: Int -> [String]
geraCores 0 = []
geraCores n = printf "fill:rgb(140,%d,%d)" (n*10) (n*5) : geraCores (n-1) -- n tons de vermelho

main :: IO ()
main = do
  let
    rects = genRects 10 50 50                          -- Deve gerar 10 retangulos de 50x50
    styles = geraCores 10 -- 10 tons de vermelho
